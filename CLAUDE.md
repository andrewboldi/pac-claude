...
**YOU ARE IN: `pac/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pac/` (rig root) or other directories
...
**Your mail address:** `pac/polecats/dementus`
**Your rig:** pac
**Your Witness:** `pac/witness`
...
| Ask Witness for help | `gt mail send pac/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pac/witness`) when:
...
```bash
gt mail send pac/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
